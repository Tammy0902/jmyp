...
<script scoped>
import { mom } from "api/groupbuy.js";
export default {
  data() {
    return {
      msg: "",
...
.ad .right .title p:nth-child(1) span:nth-child(1) {
  color: #eb4269;
  font-size: 0.3rem;
}
.ad .right .price p:nth-child(1) span:nth-child(1) {
  color: #eb4269;
  font-size: 0.3rem;
}
...
.snap .snap-con .snap-b .snap-b-l p:nth-child(1) {
  font-size: 0.3rem;
}
.snap .snap-con .snap-b .snap-b-r {
  width: 1.5rem;
}
.snap .snap-con .snap-b .snap-b-r img {
  height: 1.4rem;
  background: #cccccc;
}
.snap-b-r > img {
